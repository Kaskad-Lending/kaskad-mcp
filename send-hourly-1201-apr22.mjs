...
HF: ∞ ✅  |  Collateral: $249,798  |  Debt: $0  |  Available: $166,265
APY snapshot: KSKD 64.69%  |  IGRA 54.83%  |  WBTC borrow 2.42%
Net yield: $38,599/yr  |  Net APY: 15.46%  |  Monthly: $3,217/mo
KSKD Eligibility: Supplier ✅  |  Borrower ✅  |  Epoch 14
Action: Borrow WBTC (~$39K at 2.42%) to activate borrower-share emissions — HF stays ~5.3, well above 1.8. No KSKD rewards to claim.
\`\`\``;
  ...
  if (!connected && data.type === 'res' && !data.error) {
    ...
    ws.send(JSON.stringify({
      ...
      params: {
        ...
        idempotencyKey: 'keal-hourly-1201-20260422',
