...
HF: ∞ ✅  |  Collateral: $241,936  |  Debt: $0  |  Available: $160,766
APY snapshot: KSKD 64.71%  |  IGRA 55.45%  |  WBTC borrow 2.41%
Net yield: $38,468/yr  |  Net APY: 15.90%  |  Monthly: $3,206/mo
KSKD Eligibility: Supplier ✅  |  Borrower ✅  |  Epoch 13
Action: No KSKD rewards to claim. Debt=0 with borrower eligibility active — borrow WBTC (~$38K min at 2.41%) to capture borrower-share emissions, HF stays >> 1.8.
\`\`\``;
  ...
  if (!connected && data.type === 'res' && !data.error) {
    ...
    ws.send(JSON.stringify({
      ...
      params: {
        ...
        idempotencyKey: 'keal-hourly-1701-20260421',
