...
HF: ∞ ✅  |  Collateral: $243,846  |  Debt: $0  |  Available: $162,084
APY snapshot: KSKD 64.71%  |  IGRA 55.51%  |  WBTC borrow 2.41%
Net yield: $38,477/yr  |  Net APY: 15.79%  |  Monthly: $3,206/mo
KSKD Eligibility: Supplier ✅  |  Borrower ✅  |  Epoch 13
Action: Borrow WBTC (~$38K min at 2.41%) to activate borrower-share — HF stays >> 1.8. No KSKD rewards to claim.
\`\`\``;
  ...
  if (!connected && data.type === 'res' && !data.error) {
    ...
    ws.send(JSON.stringify({
      ...
      params: {
        ...
        idempotencyKey: 'keal-hourly-1201-20260421',
