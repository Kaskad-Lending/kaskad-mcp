...
export const CONTRACTS = {
  ...
  // NOTE: UI bundle contains two contract sets. The old set below is still active for rewards/claims.
  // New set (0x44e8Eeb pool) may be a staging/next deploy — needs confirmation from Anton before switching.
...
// Token addresses — active deploy (confirmed via manual claim tx 2026-04-03)
