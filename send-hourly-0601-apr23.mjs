...
HF: ∞ ✅  |  Collateral: $248,112  |  Debt: $0  |  Available: $165,019
APY snapshot: KSKD 63.86%  |  IGRA 56.22%  |  WBTC borrow 2.42%
Net yield: $38,656/yr  |  Net APY: 15.58%  |  Monthly: $3,221/mo
  ...
  if (!connected && data.type === 'res' && !data.error) {
    ...
    ws.send(JSON.stringify({
      ...
      params: {
        ...
        idempotencyKey: 'keal-hourly-0601-20260423',
